...
risk.m4.f2 <- foreach(i = 1:n) %dopar% {
  #if(i %in% thousand){
  #  send_text(paste("beginning model m4.f2s", i, "of 100", Sys.time(), sep = " "))
  #}
...
risk.m5.f2 <- foreach(i = 1:n) %dopar% {
  #if(i %in% thousand){
  #  send_text(paste("beginning model m5.f2s", i, "of 100", Sys.time(), sep = " "))
  #}
...
risk.m6.f2 <- foreach(i = 1:n) %dopar% {
  #if(i %in% thousand){
  #  send_text(paste("beginning model m6.f2s", i, "of 100", Sys.time(), sep = " "))
  #}
...
risk.m7.f2 <- foreach(i = 1:n) %dopar% {
  #if(i %in% thousand){
  #  send_text(paste("beginning model m7.f2s", i, "of 100", Sys.time(), sep = " "))
  #}
